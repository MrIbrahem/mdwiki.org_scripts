...
| --------------------------------------- | --------------------------------------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `page.exists()`                         | `MwClientPage.check_exists()` or `is_page_exists()` | Low                  | Return type differs: legacy returns `bool\|str`, new returns `bool`                                                                                                          |
...
| `page.get_categories()`                 | **No equivalent**                                   | Medium               | Can add via `mwclient` page.categories                                                                                                                                       |
| `page.get_langlinks()`                  | **No equivalent**                                   | Medium               | Can add via `mwclient` page.langlinks                                                                                                                                        |
| `page.purge()`                          | **No equivalent**                                   | Low                  | Trivial to add via `site.raw_api("purge", ...)`                                                                                                                              |
| `page.get_text_html()`                  | **No equivalent**                                   | Low                  | Can add via `site.raw_api("parse", ...)`                                                                                                                                     |
...
| `Find_pages_exists_or_not_with_qids(titles)` | **No equivalent**                                          | Medium               | Can add using existing batch query pattern                                                                                                                                            |
| `Get_All_pages_generator(...)`               | `site.allpages(..., generator=True)`                       | Medium               | mwclient generator returns `Page` objects, not dicts                                                                                                                                  |
...
| `UserContribs(user, limit)`                  | **No equivalent**                                          | Low                  | Can add via `site.raw_api("query", list="usercontribs", ...)`                                                                                                                         |
| `Get_template_pages(title)`                  | **No equivalent**                                          | Medium               | Can add via `site.raw_api("query", list="embeddedin", ...)`                                                                                                                           |
...
| `post_continue(params, action)`              | **No direct equivalent**                                   | **High**             | mwclient has built-in continuation for some methods but not a generic `post_continue`                                                                                                 |
| `expandtemplates(text)`                      | **No equivalent**                                          | Low                  | Can add via `site.raw_api("expandtemplates", ...)`                                                                                                                                    |
| `Parse_Text(line, title)`                    | **No equivalent**                                          | Low                  | Can add via `site.raw_api("parse", ...)`                                                                                                                                              |
| `move(old_title, to, reason)`                | `move_page(site, title, new_title, ...)` in `pages_api.py` | Low                  | Already implemented                                                                                                                                                                   |
| `upload_by_file(...)`                        | **No equivalent**                                          | Medium               | Can add via `mwclient.Site.upload()`                                                                                                                                                  |
| `users_infos(ususers)`                       | **No equivalent**                                          | Low                  | Can add via `site.raw_api("query", list="users", ...)`                                                                                                                                |
| `get_titles_redirects(titles)`               | `resolve_redirects(titles, site)` in `pages_api.py`        | Low                  | Already implemented                                                                                                                                                                   |
| `chunk_titles(titles, chunk_size)`           | **No equivalent**                                          | Low                  | Utility function; can port directly                                                                                                                                                   |
...
| `MainPage.exists()` returns `bool\|str`             | Can return string "0" or "1"               | `MwClientPage.check_exists()` returns `bool`                 |

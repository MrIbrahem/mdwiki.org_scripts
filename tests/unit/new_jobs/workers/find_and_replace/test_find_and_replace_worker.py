...
from flask_app.main_app.public_jobs.workers.find_and_replace.worker import (
...
class TestFindAndReplaceWorker:
    ...
    def test_result_type(self):
        from flask_app.main_app.public_jobs.workers.find_and_replace.objects import FindAndReplaceWorkerObject
